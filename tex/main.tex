...
\newcommand{\BottomHelperLineVerticalSpacing}{\calculateValue{42 - 30}}
...
\newcommand{\addPicturePage}[2]{
    ...
    \begin{center}
        \vspace*{-1.7 \SpacingsUnit}
        \begin{tikzpicture}
	    \node[anchor=north west,inner sep=0] at (0,0) {
                \begin{turn}{180}
                    \makebox[\textwidth]{\includegraphics[width=\paperwidth - 6mm]{#2}}
                \end{turn}
	    };
	    \draw[draw=none, fill=#1] (0,-3cm) rectangle (\paperwidth, -1.7);
        \end{tikzpicture}
    \end{center}
}
