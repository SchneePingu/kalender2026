...
\definecolor{DezemberColor}{HTML}{\colorLachsfarben}
...
\newcommand{\BottomHelperLineVerticalSpacing}{\calculateValue{42.6 - 30}}
...
%        \draw [remember picture,overlay,BottomHelperLineColor]
%        ([yshift=\paperheight - 3 mm]current page.south west)
%        --
%        ([yshift=\paperheight - 3 mm]current page.south east);
%\begin{tikzpicture}[remember picture,overlay]
%  \draw[red,line width=0.5pt]
%    ([yshift=-3 mm, xshift=3 mm]current page.north west)
%    rectangle
%    ([yshift=3 mm, xshift=-3 mm]current page.south east);
%\end{tikzpicture}
\begin{tikzpicture}[remember picture,overlay]
  \draw[blue,line width=0.5pt]
    ([yshift=-3 mm, xshift=3 mm]current page.north west)
    rectangle
    ([yshift=-300 mm, xshift=-3 mm]current page.north east);
\end{tikzpicture}
\end{tikzpicture}
}
...
\newcommand{\addPicturePage}[2]{
    ...
    \begin{center}
        \vspace*{-0.6 \SpacingsUnit}
        \begin{tikzpicture}
	    \node[anchor=north west,inner sep=0] at (0,0) {
                \begin{turn}{180}
                    \makebox[\textwidth]{\includegraphics[width=\paperwidth - 16mm]{#2}}
                \end{turn}
	    };
